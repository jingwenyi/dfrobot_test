...
//		sMacAddr[5] = (u1Byte)GetRandomNumber(1, 254);
	...
	else
	{
		...
		_rtw_memcpy(pHalData->EEPROMMACAddr, &hwinfo[EEPROM_MAC_ADDR_88ES], ETH_ALEN);
	...
	)
{
	...
	Hal_EfuseParseMACAddr_8188ES(padapter, pHalData->efuse_eeprom_data, pHalData->bautoload_fail_flag);
