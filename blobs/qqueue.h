...
#else
#define QQ_SIZE       0xc0000//0x30000  2016.2.23 jingwenyi modify
#endif
...
#endif
{
    ...
    uint16_t m_col;//0-2为mode,3-15为行号
    int16_t m_v;
    int16_t m_u;
    uint16_t m_y;
...
/*
	...
	unsigned char  model  ; // which color channel  支持识别256中颜色
    unsigned short row    ;     //支持显示高为 0xffff
    unsigned short startCol ; // inclusive   支持的显示宽为0xffff
    unsigned short endCol   ; // inclusive
*/
//qval
