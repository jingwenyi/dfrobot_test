...
#define USE_RGB_RECOGNITION    //定义了这个 宏，表示用rgb数据进行识别
//#define USE_RBBG_RECOGNITION  //定义了这个宏，表示用rggb 数据进行识别
...
#if defined(USE_RBBG_RECOGNITION)  //jwy add  2016.4.1  rggb 求发
...
{
#if defined(USE_RBBG_RECOGNITION)  //这是计算rggb 数据的u v 值 jwy add 2016.4.1
